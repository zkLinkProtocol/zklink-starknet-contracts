...
fn test_zklink_cancelOutstandingDepositsForExodusMode_success() {
    ...
    //
    // data = [1334420292643450702982333137294458880, 4398046511104000000000000000000, 25701]
    // pending_data = 123770669233550103926826354
    // pending_data_size = 11
    let pubdata0 = Bytes {
        data: array![1334420292643450702982333137294458880, 4398046511104000000000000000000, 25701],
        pending_data: 123770669233550103926826354,
        pending_data_size: 11
    };
    ...
    //
    // data = [1334420292643455425348816006939672576, 10995116277760000000000000000000, 0]
    // pending_data = 418430673765
    // pending_data_size = 11
    let pubdata1 = Bytes {
        data: array![1334420292643455425348816006939672576, 10995116277760000000000000000000, 0],
        pending_data: 418430673765,
        pending_data_size: 11
    };
