...
fn u128_fast_shift(exp: usize) -> u128 {
    if exp == 0 {
        0x1_u128
    } else if exp == 1 {
        0x100_u128
        ...
        panic_with_felt252('exp too big')
    }
}

// return 2^exp where exp in [0, 255]
fn u256_fast_pow2(exp: usize) -> u256 {
